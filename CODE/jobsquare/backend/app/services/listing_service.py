...
from app.dao.repositories.listing_repository import ListingRepository, LISTING_TYPE_MAP
...
class ListingService:
    ...
    async def create_listing(self, user_id: str, data: dict) -> dict:
        listing_type = data.get("listing_type", "job_offer")
        data["listing_type_sid"] = LISTING_TYPE_MAP.get(listing_type, 6)
        ...
        data["active"] = True
        data["listing_type_sid"] = LISTING_TYPE_MAP.get(data.get("listing_type", "job_offer"), 6)
