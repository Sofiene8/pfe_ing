...
class SJB_Classifieds_PlusFeaturedListings extends SJB_Function
{
    public function execute()
    {
       
	   $template = SJB_Request::getVar('template', 'plus_featured_listings.tpl');
        ...
        $tp->assign('listing_type', $listingType);
		      $tp->assign('alaune', 'Offres d\'emploi les plus recherchées');
