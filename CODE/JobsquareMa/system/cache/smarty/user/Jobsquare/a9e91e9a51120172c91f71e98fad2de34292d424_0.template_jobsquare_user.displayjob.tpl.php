...
/* Smarty version 4.3.0, created on 2026-03-04 11:43:18
  from 'template_jobsquare_user:displayjob.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_69a81ad6948cb1_22876375',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a9e91e9a51120172c91f71e98fad2de34292d424' => 
    array (
      0 => 'template_jobsquare_user:displayjob.tpl',
      1 => 1772573823,
...
function content_69a81ad6948cb1_22876375 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="utf-8">
...
">
    ...
    <link rel="alternate" type="application/rss+xml" title="<?php $_block_plugin36 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
...
$_block_repeat=false;
ob_start();
echo $_block_plugin37->translate(array(), $_block_content37, $_smarty_tpl, $_block_repeat);
...
$_block_repeat=true;
echo $_block_plugin38->translate(array('metadata'=>$_smarty_tpl->tpl_vars['METADATA']->value['HEAD']), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo $_smarty_tpl->tpl_vars['HEAD']->value;
$_block_repeat=false;
echo $_block_plugin38->translate(array('metadata'=>$_smarty_tpl->tpl_vars['METADATA']->value['HEAD']), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
<body class="tinyheader displayjobtpl">
        ...
        $("#apply-modal")
                .on('show.bs.modal', function(event){
                    ...
                    if (button.data('applied')) {
                        $(this).find('.modal-body').html('<p class="alert alert-danger"><?php $_block_plugin39 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
