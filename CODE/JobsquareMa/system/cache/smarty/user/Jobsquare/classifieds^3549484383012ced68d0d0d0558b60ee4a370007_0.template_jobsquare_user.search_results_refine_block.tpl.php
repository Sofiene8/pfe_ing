...
/* Smarty version 4.3.0, created on 2026-03-04 11:43:28
  from 'template_jobsquare_user:search_results_refine_block.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_69a81ae00fa5a0_90333554',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3549484383012ced68d0d0d0558b60ee4a370007' => 
    array (
      0 => 'template_jobsquare_user:search_results_refine_block.tpl',
      1 => 1772573830,
...
function content_69a81ae00fa5a0_90333554 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if (!empty($_smarty_tpl->tpl_vars['currentSearch']->value)) {?>
	<div class="current-search" style="display:none;">
		<div class="current-search__title"><?php $_block_plugin35 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
...
"><?php $_block_plugin36 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
...
$_block_repeat=false;
ob_start();
echo $_block_plugin36->translate(array(), $_block_content36, $_smarty_tpl, $_block_repeat);
...
$_block_plugin37 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
...
$_block_repeat=false;
ob_start();
echo $_block_plugin38->translate(array(), $_block_content38, $_smarty_tpl, $_block_repeat);
echo htmlspecialchars((string)ob_get_clean(), ENT_QUOTES, 'UTF-8', true);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_content39 = ob_get_clean();
$_block_repeat=false;
ob_start();
echo $_block_plugin39->translate(array(), $_block_content39, $_smarty_tpl, $_block_repeat);
echo htmlspecialchars((string)ob_get_clean(), ENT_QUOTES, 'UTF-8', true);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
while ($_block_repeat) {
ob_start();?>Refine by $field_caption<?php $_block_content40 = ob_get_clean();
$_block_repeat=false;
ob_start();
echo $_block_plugin40->translate(array(), $_block_content40, $_smarty_tpl, $_block_repeat);
echo htmlspecialchars((string)ob_get_clean(), ENT_QUOTES, 'UTF-8', true);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
					</a>
...
while ($_block_repeat) {
ob_start();?>Refine by $field_caption<?php $_block_content41 = ob_get_clean();
$_block_repeat=false;
ob_start();
echo $_block_plugin41->translate(array(), $_block_content41, $_smarty_tpl, $_block_repeat);
echo htmlspecialchars((string)ob_get_clean(), ENT_QUOTES, 'UTF-8', true);
}
...
echo $_smarty_tpl->tpl_vars['val']->value['sid'];
						...
						<?php $_block_plugin42 = isset($_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0] : null;
...
<?php }
$_block_plugin43 = isset($_smarty_tpl->smarty->registered_plugins['block']['javascript'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['javascript'][0][0] : null;
if (!is_callable(array($_block_plugin43, '_tpl_javascript'))) {
...
$_block_repeat=true;
echo $_block_plugin43->_tpl_javascript(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	<?php echo '<script'; ?>
>
...
echo $_block_plugin43->_tpl_javascript(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
