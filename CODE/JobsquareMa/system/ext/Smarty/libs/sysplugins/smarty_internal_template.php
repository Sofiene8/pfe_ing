...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
    ...
    public function render($no_output_filter = true, $display = null)
    {
		...
		//template__system/admin_admin:CxampphtdocsTanitV8templates_systemadminpaginationpagination_top.tpl
		//template__system/admin_admin:CxampphtdocsTanitV8templates_systemadminusersuser_search_form.tpl"
        // checks if template exists
		 if (!$this->source->exists) {
		// var_dump($this->source);exit;	
