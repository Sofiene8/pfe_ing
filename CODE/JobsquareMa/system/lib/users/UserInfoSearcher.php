...
class SJB_UserInfoSearcher extends SJB_ObjectInfoSearcher
{
	...
	function __construct($limit = false, $sorting_field = false, $sorting_order = false, $inner_join = false, $limitByPHP= false)
	{
	...
	function getObjectInfo($sorting_fields, $inner_join = false, $relevance = false)
	{
        ...
        /** custom ***************************************************/
        if ($this->sorting_order == 'RAND()') {
            $sql_string .= 'ORDER BY RAND()';
        }
        /** custom ***************************************************/
