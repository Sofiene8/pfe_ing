...
class SJB_UserProfileFieldManager extends SJB_ObjectManager
{
	...
	{
		return SJB_UserProfileFieldDBManager::saveUserProfileField($user_profile_field);
	}
	...
	public static function getUserProfileFieldSIDByID($listing_field_id)
	{
		$listing_field_info = SJB_UserProfileFieldDBManager::getUserProfileFieldInfoByID($listing_field_id);
