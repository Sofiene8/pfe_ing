			...
			if (is_array($criteria_data)) {
				foreach($criteria_data as $criterion_type => $criterion_value) {
					...
					if (!is_null($criterion)) {
						...
						$property_is_user= SJB_ListingManager::propertyIsUser($property_name) || (!empty($property) && $property->isUser());
						...
						elseif ($property_is_user) {
							$criteria['user'][$property_name][] = $criterion;
						}
						else {
