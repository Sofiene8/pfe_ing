...
<body 
{if  $GLOBALS.user_page_uri == '/jobs/' } class="tinyheader page-recherche" 
{elseif   $GLOBALS.user_page_uri == '/training/'} class="tinyheader page-training" 
{elseif   $GLOBALS.user_page_uri == ''} class="body_home_page" 
 {elseif   $GLOBALS.user_page_uri == '/resumes/'} class="tinyheader page-resume" 
{else} class="pageinterne" {/if} 
>


   {if  $GLOBALS.user_page_uri == '/resumes/' } 
   {include file="../menu/header_search_resumes.tpl"}
{elseif  $GLOBALS.user_page_uri == '/jobs/' }
