{if $listings}
	<section class="main-sections main-sections__listing__latest listing__latest">
		<div class="container container-fluid listing">
			<h4 class="listing__title {if 'banner_right_side'|banner}with-banner{/if}">[[Latest {$listing_type}s]]</h4>
	...
	<div class="view-all text-center {if 'banner_right_side'|banner}with-banner{/if}">
		{if $listing_type == 'Training' }
			<a href="{$GLOBALS.site_url}/trainings/" class="btn view-all__btn btn__white">[[View all trainings]]</a>
        {elseif $listing_type == 'Job' }
			<a href="{$GLOBALS.site_url}/jobs/" class="btn view-all__btn btn__white">[[View all jobs]]</a>
		{else}
			<a href="{$GLOBALS.site_url}/jobs/" class="btn view-all__btn btn__white">[[View all {$listing_type}s]]</a>
		{/if}
