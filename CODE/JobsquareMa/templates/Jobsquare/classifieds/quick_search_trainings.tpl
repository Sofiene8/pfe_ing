<div class="container container-fluid quick-search-training">
	<div class="quick-search__wrapper well">
		<form action="{$GLOBALS.site_url}/trainings/" class="form-inline row">
			...
			<div class="form-group form-group__btn">
				<button type="submit" class="quick-search__find btn btn__orange btn__bold ">[[Find Trainings]]</button>
			</div>
		</form>
	</div>
</div>