{foreach from=$form_fields item=form_field}
	...
	{elseif ($listing_type_id == "Resume" || $listing.type.id == "Resume"  || $listingTypeID == "resume" || $listing.type.id == "resume") && $form_field.id == "anonymous"}
		<div class="form-group">
			<label class="form-label">[[{$form_field.caption}]] {if $form_field.is_required}*{/if}</label>
			{input property=$form_field.id}
		</div>
	{elseif ($listingTypeID == "Job" || $listing.type.id == "Job" || $listingTypeID == "job" || $listing.type.id == "job") && $form_field.id == 'ApplicationSettings'}
		<div class="form-group">
			<label class="form-label">[[{$form_field.caption}]] {if $form_field.is_required}*{/if}</label>
			{input property=$form_field.id template='applicationSettings.tpl'}
		</div>
	{elseif ($listingTypeID == "Job" || $listing.type.id == "Job" || $listingTypeID == "job" || $listing.type.id == "job") && $form_field.id == 'expiration_date'}
