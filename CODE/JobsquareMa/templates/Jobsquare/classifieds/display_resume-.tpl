		...
		<div class="container">
			<div class="results text-left">
				{if $url == "/my-resume-details/{$listing.id}/"}
                    ...
                    {/javascript}
				{else}
					{if $backPage && is_numeric($searchID)ј}
		...
		<div class="row details-body details-body__resume">
			<div class="sidebar profile col-xs-10 col-xs-offset-1 col-sm-offset-0">
				<div class="sidebar__content">
					...
					{else}
					<a href="Javascript:autosuggest('{$listing|listing_url}','{$listing.id}' );" class="see-cv"><i class="fa fa-eye"></i> Visualiser coordonnées </a>
					<script>
			...
			<div class="pull-left details-body__left">
				...
				{if $listing.WorkExperience}
					<h3 class="details-body__title">[[{$form_fields.WorkExperience.caption|escape}]]</h3>
					<div class="details-body__content content-text">{display property='WorkExperience'}</div>
				{/if}
				{if $listing.Education}
					<h3 class="details-body__title">[[{$form_fields.Education.caption|escape}]]</h3>
