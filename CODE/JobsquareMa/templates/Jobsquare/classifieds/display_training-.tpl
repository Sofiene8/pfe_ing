...
{if $smarty.request.isBoughtNow}
	<div class="alert alert-bought-now text-center content-text cloud">
		{if $listing.active|status == 'pending'}
	...
	<div class="details-header">
		<div class="container">
			<div class="results text-left">
				{if $url == "/my-training-details/{$listing.id}/"}
				...
				{else}
					{if $backPage && is_numeric($searchID)}
						<a href="{$GLOBALS.site_url}/trainings/?searchID={$searchID}&action=search&listings_per_page={$backPage * 20}#{$listing.id}"
						   class="btn__back">
							[[Back]]
						</a>
					{else}
			...
			<div class="job-type">
				...
				{/if}
				{display property='id_Training_Categories' template="multilist_job_category.tpl"}
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row details-body">
			<div class="pull-left details-body__left">
				<h3 class="details-body__title">[[{$form_fields.JobDescription.caption|escape}]]</h3>
				...
				<div class="sidebar__content">
					...
					<div class="profile__info">
                        ...
                        <div>
							...
							{if $listing.user.PrivateSpace}
							<a target="_blanc" class="btn__profile" href="{$GLOBALS.site_url}/entreprise/{$listing.user.PrivateSpace}">Site de l'entreprise</a>
							{/if}
					   </div>
					</div>
				</div>
...
<div class="details-footer  {if $GLOBALS.user_page_uri == '/training-preview/'}job-preview{/if}">
	<div class="container">
		{if $GLOBALS.user_page_uri == '/training-preview/'}
