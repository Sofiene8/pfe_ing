...
<table cellpadding="5" border="0">
	<tr>
		<td width="70%"><h3 style="color: {$resumeColor.code};">{$listing.user.FullName}</h3></td>
	...
	<tr>
		<td>
            ...
            {/if}
			 ...
			 {if $listing.Licence}<img style="height: 14px; " src="{$GLOBALS.site_url}/templates/Jobsquare/assets/images/clock.png" />&nbsp;&nbsp;&nbsp;&nbsp;Permis de conduire {/if}{if $listing.Motorized}-Motorisé{/if}<br>		 
...
{if $listing.Skills}
	...
	<tr>
		<th style="min-width:10%;background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">[[{$form_fields.Skills.caption|escape}]]</h3></th>
		<th style=" border-bottom: 1px solid {$resumeColor.code};"></th>
	</tr>
	<tr>
...
{if $listing.WorkExperience}
	{*<table cellpadding="15">*}
		<tr>
			<th  style="background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">[[{$form_fields.WorkExperience.caption|escape}]]</h3></th>
			<th  style=" border-bottom: 1px solid {$resumeColor.code};"></th>
...
{if $listing.Education}
	{*<table cellpadding="15">*}
		<tr>
			<th  style="background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">[[{$form_fields.Education.caption|escape}]]s</h3></th>
			<th  style=" border-bottom: 1px solid {$resumeColor.code};"></th>
		</tr>
		<tr>
			<td colspan="2">
...
{foreach from=$form_fields item=list_value}
	...
	{*<table cellpadding="15">*}
				<tr>
					<th  style="background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">[[{$list_value.caption|escape}]]</h3></th>
					<th  style=" border-bottom: 1px solid {$resumeColor.code};"></th>
...
{/foreach}
 {if $listing.salary}
							{*<table cellpadding="15">*}
				<tr>
					<th  style="background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">Salaire Minimum</h3></th>
					<th  style=" border-bottom: 1px solid {$resumeColor.code};"></th>
...
{if $listing.Linkedin_link || $listing.Facebook_link || $listing.Twitter_link || $listing.Behance_link || $listing.Instagram_link || $listing.GitHub_link || $listing.StackOverflow_link || $listing.YouTube_link || $listing.Blog_link || $listing.Website_link || $listing.Other_link}
	{*<table cellpadding="15">*}
	<tr>
		<th style="min-width:10%;background-color:{$resumeColor.code}; border-bottom: 1px solid {$resumeColor.code};"><h3 style="color: white;">Présence en ligne</h3></th>
		<th style=" border-bottom: 1px solid {$resumeColor.code};"></th>
	</tr>
