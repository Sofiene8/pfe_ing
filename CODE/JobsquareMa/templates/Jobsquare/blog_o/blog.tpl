{title}
Blog du portail de l'emploi en Maroc
{/title}
{keywords}
 Blog du portail de l'emploi en Maroc, Blog Jobsquare
{/keywords}
{description}
   Visitez le blog du portail de l'emploi en Maroc : Jobsquare! Nous apportons notre soutien aux candidats cherchant du travail, comme aux employeurs.
{/description}
<div class="posts-list">
    <h1 class="title__primary title__primary-small title__centered title__bordered">[[Blog]]</h1><br><br>
				...
				{if $post.image}
					<div class="media-left listing-item__logo">
						<a href="{$GLOBALS.site_url}/blog/{$post.sid}/{$post.title|pretty_url}/">
							<img class="media-object profile__img-company" src="{$post.image}" alt="{$post.title|escape}" title="{$post.title|escape}">
						</a>
					</div>
				{/if}
