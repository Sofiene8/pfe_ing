...
<div class="page-title">
    ...
    <div class="page-title__buttons">
        {if $GLOBALS.plugins.DisqusPlugin.active}
            {if $GLOBALS.settings.disqus_forum_id}
                <a target="_blank" href="https://{$GLOBALS.settings.disqus_forum_id|escape}.disqus.com/admin/" class="btn btn--bordered">[[Manage Comments]]</a>
            {else}
                <a href="{$GLOBALS.admin_site_url}/system/miscellaneous/disqus/" class="btn btn--bordered">[[Manage Comments]]</a>
            {/if}
        {else}
            <a href="{$GLOBALS.admin_site_url}/system/miscellaneous/plugins/?action=save&plugin=DisqusPlugin&active=1" class="btn btn--bordered">[[Manage Comments]]</a>
        {/if}
