...
<p><a href="{$GLOBALS.site_url}/add-banner/?groupSID={$bannerGroup.sid}" class="btn btn--primary">[[Add a New Banner]]</a></p>
			...
			<tr>
				<td colspan="7">
					{if $banner.type == 'application/x-shockwave-flash'}
						<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://active.macromedia.com/flash2/cabs/swflash.cab#version=4,0,0,0" ID="banner"" WIDTH="{$banner.width}" HEIGHT="{$banner.height}">
						<PARAM NAME="movie" VALUE="{$bannersPath}{$banner.image_path}">
						<PARAM NAME="quality VALUE="high">
						<PARAM NAME="loop" VALUE="true">
						<EMBED FlashVars="sjb_banner_link={capture name="banner_link"}{$GLOBALS.user_site_url}/go-link/?bannerId={$banner.id}{/capture}{$smarty.capture.banner_link|escape:'url'}&sjb_banner_window={$banner.openBannerIn}" src="{$bannersPath}{$banner.image_path}" loop="true" quality="high"  WIDTH="{$banner.width}" HEIGHT="{$banner.height}" TYPE="application/x-shockwave-flash"  PLUGINSPAGE="https://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash">
						</EMBED>
					{else}
