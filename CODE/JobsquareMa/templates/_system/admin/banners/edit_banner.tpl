			...
			<tr>
				<td colspan="4">
					{if $banner.type == "application/x-shockwave-flash"}
						...
						<embed src="{$bannersPath}{$banner.image_path}" loop="false" quality="high" WIDTH="{$banner.width}" HEIGHT="{$banner.height}" TYPE="application/x-shockwave-flash"  PLUGINSPAGE="https://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash">
						</embed>
						</object>
